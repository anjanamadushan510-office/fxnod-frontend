...
// Replace any null bytes that might have gotten injected
content = content.replace(/\0/g, '');

const searchString = 'if (zigzagData.length > 0) zigzag.setData(zigzagData as any);';

if (!content.includes(searchString)) {
  console.log('Could not find zigzagData!');
} else {
...
`;
  ...
  if (content.includes("ind.type === 'bollinger'")) {
