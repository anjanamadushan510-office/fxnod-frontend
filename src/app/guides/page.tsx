      ...
      <main className="px-5 sm:px-8 lg:px-12 py-10 sm:py-20 flex-1">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {mockPosts.map((p) => (
              <Link key={p.slug} href={`/guides/${p.slug}` as Route} className="bg-panel border border-line rounded-2xl overflow-hidden hover:border-zinc-600 transition flex flex-col group block">
