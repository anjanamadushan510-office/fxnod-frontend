...
export function DashboardMetrics({ onTopUp, onSend }: DashboardMetricsProps) {
  ...
  return (
    <div className="grid grid-cols-2 xl:grid-cols-4 gap-3 sm:gap-4">
      <article className="bg-[#101827] border border-[#24344F] rounded-2xl p-6 lg:p-7">
      ...
      <article className="bg-[#101827] border border-[#24344F] rounded-2xl p-6 lg:p-7 hover:bg-white/[0.02] cursor-pointer transition-colors">
        <div className="flex items-start justify-between mb-4">
        ...
        <p className="font-display text-3xl font-semibold tabular-nums text-white">2</p>
      ...
      <article className="bg-[#101827] border border-[#24344F] rounded-2xl p-6 lg:p-7 hover:bg-white/[0.02] cursor-pointer transition-colors">
        ...
        <p className="font-display text-3xl font-semibold tabular-nums text-white">3</p>
      ...
      <article className="bg-[#101827] border border-[#24344F] rounded-2xl p-6 lg:p-7 hover:bg-white/[0.02] cursor-pointer transition-colors">
        ...
        <p className="font-display text-3xl font-semibold tabular-nums text-white">{fmtUSD(86.40)}</p>
